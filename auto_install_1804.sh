...
# -----------------------------------------
# 6) Cesium -- 1.67 (Released Mar. 2, 2020):
...
mkdir ${HOME}/cesium
cd ${HOME}/cesium
wget https://github.com/AnalyticalGraphicsInc/cesium/releases/download/1.67/Cesium-1.67.zip
unzip Cesium-1.67.zip
rm Cesium-1.67.zip
...
# FIXME -- Need to copy jMAVSim/jMAVlib to our github repo, and
#          remove fork from DrTon				
